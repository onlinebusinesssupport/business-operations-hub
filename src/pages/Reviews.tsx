          ...
          <motion.div {...fade} transition={{ duration: 0.5 }} className="flex items-start justify-between gap-4 flex-wrap">
            <div className="max-w-2xl">
              ...
              <h1 className="mt-4 font-display text-3xl md:text-4xl font-bold text-foreground">
                What clients say about working with Nkululeko
              </h1>
                ...
                <motion.div initial={{ opacity: 0, y: 24, scale: 0.97 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 24, scale: 0.97 }}
                  ...
                  {submitted ? (
                    <div className="text-center space-y-4 py-8">
                      ...
                      <p className="text-sm text-muted-foreground">Your honesty helps Nkululeko improve and grow. Your trust is never taken lightly.</p>
                    ...
                    <>
                      ...
                      {step === 0 && (
                        <p className="text-sm text-muted-foreground text-center">
                          Nkululeko cares deeply about doing meaningful work. This takes 60 seconds — your honesty helps him improve and grow.
                        </p>
                      )}
                      ...
                      <AnimatePresence mode="wait">
                        {step === 0 && (
                          <motion.div key="s0" {...fade} className="space-y-6">
                            <div className="space-y-3">
                              <label className="text-sm font-medium text-foreground">Overall, how would you rate your experience working with Nkululeko?</label>
                              <div className="flex justify-center"><StarRating value={form.score_overall} onChange={(v) => set("score_overall", v)} size={28} /></div>
                            </div>
                            <div className="space-y-3">
                              <label className="text-sm font-medium text-foreground">Which service did Nkululeko support you with?</label>
                        ...
                        {step === 2 && (
                          <motion.div key="s2" {...fade} className="space-y-5">
                            <div className="space-y-2">
                              <label className="text-sm font-medium text-foreground">Did Nkululeko's service deliver strong value?</label>
                              <div className="space-y-2">
                                {VALUE_OPTIONS.map((v) => (
                            ...
                            <div className="space-y-2">
                              <label className="text-sm font-medium text-foreground">What impact did Nkululeko's work have?</label>
                              <div className="flex flex-wrap gap-2">
                            ...
                            <div className="space-y-2">
                              <label className="text-sm font-medium text-foreground">Biggest change after working with Nkululeko?</label>
                        ...
                        {step === 3 && (
                          <motion.div key="s3" {...fade} className="space-y-5">
                            <div className="space-y-2">
                              <label className="text-sm font-medium text-foreground">How likely are you to recommend Nkululeko? (0–10)</label>
                            ...
                            <div className="space-y-2">
                              <label className="text-sm font-medium text-foreground">What almost stopped you from working with Nkululeko?</label>
                              <textarea value={form.almost_stopped} onChange={(e) => set("almost_stopped", e.target.value)}
                                rows={2} className="w-full px-3 py-2 text-sm bg-background border border-border focus:outline-none focus:ring-1 focus:ring-ring resize-none" />
                            </div>
                            <div className="space-y-2">
                              <label className="text-sm font-medium text-foreground">Anything you wish Nkululeko did better?</label>
                        ...
                        {step === 4 && (
                          <motion.div key="s4" {...fade} className="space-y-5">
                            <div className="space-y-2">
                              <label className="text-sm font-medium text-foreground">Can Nkululeko share your feedback publicly?</label>
                              <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                              <label className="text-sm font-medium text-foreground">Describe working with Nkululeko in one sentence</label>
              ...
              <motion.div key={r.id} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
                ...
                {r.admin_reply && (
                  <div className="bg-secondary/50 border border-border p-3 space-y-1">
                    <p className="text-[10px] font-medium text-primary uppercase tracking-wider">Response from Nkululeko · SUPPORT STUDIO™</p>
