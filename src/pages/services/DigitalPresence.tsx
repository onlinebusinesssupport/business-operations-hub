...
const idealFor = [
  "Brands that want to stay visible without staying online",
  "Founders too busy to manage their own social presence",
  "Service businesses building authority through content",
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-36 pb-20">
        <div className="container mx-auto px-6 lg:px-8 max-w-3xl">
          ...
          <motion.h1
            ...
            className="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.05] text-foreground uppercase tracking-tight"
          >
            Digital Presence
          </motion.h1>
          <motion.p
          ...
          >
            Built for brands that want to stay visible without staying online.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-6 lg:px-8 max-w-3xl">
          ...
          <p className="mt-6 text-sm text-muted-foreground leading-relaxed">
            We plan, create, and manage your content across platforms — ensuring your brand shows up consistently and professionally. No guesswork. No gaps. Just a disciplined, always-on presence.
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 lg:px-8">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-foreground uppercase tracking-tight text-center">
            Packages
          </h2>
              ...
              >
                ...
                <div className="mt-8">
                  <Link to="/apply">
                    ...
                    >
                      Build my presence <ArrowRight size={14} />
                    </Button>
                  </Link>
                </div>
              </motion.div>
      ...
      <section className="py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-6 lg:px-8 text-center max-w-2xl">
          ...
          <p className="mt-4 text-sm text-primary-foreground/70">
            Apply today and we'll design a content strategy that fits your brand.
          </p>
          <div className="mt-8">
            <Link to="/apply">
