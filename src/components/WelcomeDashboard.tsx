...
import { CheckCircle2, FileText, MessageSquarePlus, User, ArrowRight } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="mt-2 text-muted-foreground text-sm max-w-lg">
          Your account is ready. Here are a few things to help you get started with your portal.
        </p>
      </motion.div>
